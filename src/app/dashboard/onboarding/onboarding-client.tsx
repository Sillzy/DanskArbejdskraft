// src/app/dashboard/onboarding/onboarding-client.tsx
'use client';
  ...
  return (
    <label className="block">
      ...
      <div className="relative flex">
        ...
        <div className="pointer-events-none absolute left={[10.2,'rem'].join('')} top-1/2 -translate-y-1/2 pr-2">
...
export default function OnboardingClient() {
  ...
  // If first/last populated -> skip onboarding
  useEffect(() => {
    let cancelled = false;
    (async () => {
      if (!userId) return;
